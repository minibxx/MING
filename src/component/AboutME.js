            ...
            <div className='w-[65%] m-[auto] '>
                <div className='flex justify-between mt-[90px] m-[auto]'>
                    ...
                    <ul className='w-[80%] flex flex-col gap-[3%]'>
                        ...
                        <li>참여한 동아리 내의 다양한 프로젝트에서 기획 및 디자인 파트로 활동하며, 사용자 중심의 디자인을 구현하고 웹 개발에
                            접목시키는 역할을 수행하였습니다. 이를 통해 사용자 경험을 최적화하고 서비스의 성능을 향상시키는 디자인에
                            대해 배우고 생각해볼 수 있었습니다.</li>
                        <li className='mt-[15px]'>프론트엔드 양성과정을 수강하며 React, Html/Css, JavaScript, Next 등을 학습하고 사용한 경험이 있습니다. <br />저는 사용자와
                        ...
                        <div className='mt-[15px]'> ✉️ alsdbqls10@duksung.ac.kr 
