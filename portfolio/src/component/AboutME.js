            ...
            <div className='row me'>
                ...
                <div>
                    <ul>
                        ...
                        <li>작년에는 다양한 프로젝트에서 기획 및 디자인 파트로 활동하며, 사용자 중심의 디자인을 구현하고 웹 개발에 
                            접목시키는 역할을 수행하였습니다. 이를 통해 사용자 경험을 최적화하고 서비스의 성능을 향상시키는 디자인에 
                            대해 배우고 생각해볼 수 있었습니다.</li>
                        <li>올해는 프론트엔드 양성과정을 수강하며 React, Html/Css, JavaScript, Next 등을 학습하고 있습니다. 저는 사용자와 
                            인터랙션이 가능하면서도 경쟁력 있는 기능을 가지고 있으며, 동시에 시각적으로 매력적인 웹 서비스 개발을 희망합니다.</li>
