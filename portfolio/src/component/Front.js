    ...
    <>
      <div className='front'>
        <div className='pofols'>
          <a onMouseEnter={() => onMouseEnterOnProject(1)} href='https://github.com/gardening-y/Helpkiosk'>
            [SSOCK] <br /> 음성 인식을 이용한 <br />모바일 키오스크, 쏙
          </a>
          <a onMouseEnter={() => onMouseEnterOnProject(2)} href=''>
            [Wealth] <br />여성에 의한, 여성을 위한 <br />인공지능 기반 <br />헬스 보조 서비스
          </a>
          <a onMouseEnter={() => onMouseEnterOnProject(3)} href=''>
            [KEYGEL] <br />(주) 키젤글로벌 <br /> 공식 사이트 KEYGEL
          </a>
          <a onMouseEnter={() => onMouseEnterOnProject(4)} href=''>
            [ToEAT]<br /> 오늘 뭐먹지? 서울 맛집 <br />소개 서비스, 투잇
          </a>
          <a onMouseEnter={() => onMouseEnterOnProject(5)} href=''>
            [별별연인] <br />사주 기반 <br /> 연인 매칭 서비스
          </a>
          <a onMouseEnter={() => onMouseEnterOnProject(6)} href=''>
            [U-CLE] <br />하루 10분 회고하며 <br />매일 1% 성장하다
          </a>
        </div>
