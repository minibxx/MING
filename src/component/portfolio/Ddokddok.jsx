            ...
            <ContentBox>
                ...
                <Flex>
                    ...
                    <div className='w-[55%]'>
                        ...
                        <div >
                            이 프로젝트는 개발 경험이 적은 팀원이 대부분이라 포지션을 정하는 것부터 어려움이 있었습니다. 파트가 재조정되면서 프론트엔드를 혼자 담당하게 된 데다가 신경 써야 할 것이 배로 늘어났습니다. 웹 통신 과정이나 백엔드 로직에 대해서도 함께 고민해야 했고, 부족한 지식으로 팀원들을 이해시키고 납득시켜야 하는 일 이 잦았습니다. 결국 배포 서버로 전송한 영상 및 음성 파일에 접근해 분석 코드를 적용하는 것이 불가능하다는 점이 마감에 닥쳐서야 대두되었습니다. 팀원들을 의심하고 분위기를 와해시키고 싶지 않아 한 발 물러섰던 것이 결국 큰 문제로 돌아오게 되었습니다. 프로젝트의 효율적인 진행을 위해 앞으로는 잘 아는 파트와 내용이 아니더라도 의문과 의심이 생기면 보다 적극적으로 문제 제기를 하고, 이슈 여부를 함께 확인하겠다고 다짐했습니다.
                        </div>
