    ...
    <>
      ...
      <div className='flex justify-between my-[50px]'>
        <div className='bg-[#D8DAF1] relative w-[33vw] py-[50px]'>
          <div className='font-bold text-[80px] mb-[10px] text-center mt-[10px] mb-[20px] h-[120px] text-[gray]'>Html / Css</div>
        ...
        <li> HTML5 시멘틱 요소를 이해하고 활용하여 접근성과 유지보수성을 개선 </li>
          ...
          <div className='font-bold text-[80px] mb-[10px] text-center mt-[10px] mb-[20px] h-[120px] text-[gray]'>React / Next</div>
          <div className='pl-[40px]'>
        ...
        <div className='bg-[#D8DAF1] relative w-[33vw] py-[50px] '>
          <div className='font-bold text-[80px] mb-[10px] text-center mt-[10px] mb-[20px] h-[120px] text-[gray]'> JS / TS</div>
          <div className='pl-[40px]'>
        ...
        <li>비동기 요청 및 API 통신을 처리하는 Axios / Fetch API 활용</li>
