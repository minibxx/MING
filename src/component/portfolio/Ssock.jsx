			...
			<Flex>
				<div className='w-[55%]'>
					...
					<div>
						...
						사용자가 음성으로 주문한 메뉴를 텍스트로 전환했을 때 공백, 줄바꿈 등의 이유로 음성 결과 대조가 정확하게 이루어지지 않는 문제점이 있었습니다. 
						문자열을 분할해 배열로 변환하고 다시 문자열로 재결합하여 결과 텍스트를 도출하는 방식으로 구현했습니다. 
						바닐라 자바스크립트를 사용한 HTML 코드에 Django 템플릿 언어를 결합하는 과정에서 문자열, 템플릿 리터럴이 혼동되는 문제점도 있었습니다.
					</div>
