...
const ContentBox = styled.div`
	...
	padding: 30px 110px;
	background-image: linear-gradient(#F9EDED, #fff);
	margin-bottom: 70px;
`;
function Ssock() {
	return (
		<ContentBox>
			<div className='flex gap-[50px] py-[30px]'>
				...
				<div>
					...
					<div className='mb-[10px]'>2023. 04~ .06</div>
				</div>
				<div>
					<div className='text-[gray]'>기여도</div>
					<div className='mb-[10px]'>Plan 70 | Design 100 | FrontEnd 100</div>
				</div>
				<div>
				...
				<div>
					<div className='flex gap-[10px]'>
						<a className='w-[45px] flex' href='https://github.com/gardening-y/Helpkiosk'>
							<img src={github} />
						</a>
